...
seurat_ccycle <- function(group=c("sudo","docker"), scratch.folderDOCKER, scratch.folderHOST, file ,separator ,seed){
  ...
  matrixName=paste(matrixNameC[seq(1,positions1-1)],collapse="")
...
dockerID_name="dockerID"
  ...
  #executing the docker job
    params <- paste("--cidfile ",data.folder,"/", dockerID_name," -v ",scrat_tmp.folderHOST,":/scratch -v ", data.folderHOST, ":/data -d docker.io/repbioinfo/seuratccycle  Rscript /home/main.R ",matrixName," ",format," ",separator," ",seed,sep="")
