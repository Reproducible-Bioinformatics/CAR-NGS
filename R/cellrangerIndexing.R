...
#' @author Luca Alessandr<U+00EC>, Sebastian Bucatariu, Agata D'Onofrio
#'
#'
...
#'
#' cellrangerIndexing(
#'   group = "docker", scratch.folderDOCKER = "/data/scratch", scratch.folderHOST = "/data/scratch",
...
cellrangerIndexing <- function(group = c("sudo", "docker"), scratch.folderDOCKER, scratch.folderHOST, genomeFolder, gtf.url, fasta.url, bio.type = c(
